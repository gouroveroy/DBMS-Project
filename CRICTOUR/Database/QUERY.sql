...
SELECT * FROM TEAM;
SELECT * FROM DELETED_TEAM;

SELECT * FROM PLAYER;
SELECT * FROM DELETED_PLAYER;
SELECT * FROM PERSON;
SELECT * FROM DELETED_PERSON;

SELECT PERSON.FIRST_NAME || ' ' || PERSON.LAST_NAME, DREAM11_PLAYERS_POINT(PLAYERID)
FROM PLAYER
JOIN PERSON
...
WHERE TOURNAMENT.TOURNAMENT_ID = 4;
