...
=======
-- TABLE FOR PLAYER PROFILE NOT CREATED YET
CREATE TABLE PLAYER_PROFILE (
    ...
    WICKETS INTEGER,
    MAIDEN_OVERS INTEGER,
    ECONOMY_RATE INTEGER,
    BEST_BOWLING_WICKET INTEGER,
    BEST_BOWLING_RUN INTEGER,
    BOWLING_AVERAGE INTEGER,
    FIVE_WICKETS INTEGER,
    TEN_WICKETS INTEGER,
    HATRICKS INTEGER,
    PRIMARY KEY (PLAYERID, MATCH_TYPE),
    FOREIGN KEY (PLAYERID) REFERENCES PLAYER(PLAYERID)
);

-- Add one more column to store the player ranking for three formats
...
>>>>>>> a4ed6995f99a7818ac400b447f69f79c178ad676
